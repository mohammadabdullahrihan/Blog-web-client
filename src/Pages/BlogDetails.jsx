...
const BlogDetails = () => {
    ...
    useEffect(() => {
        // Fetch blog details
        axios.get(`https://blog-web-server-kappa.vercel.app/blogs/${id}`).then((response) => {
            setBlog(response.data);
        });

        // Fetch comments for the blog
        axios.get(`https://blog-web-server-kappa.vercel.app/comments/${id}`).then((response) => {
    ...
    const handleAddComment = () => {
        ...
        axios.post("https://blog-web-server-kappa.vercel.app/comments", commentData).then((response) => {
    ...
    if (!blog) return <div className="text-center text-white">No blog found for the given ID.</div>;
        ...
        <div className="bg-black text-white p-6 space-y-8">
            ...
            <div className="blog-content lg:flex">
                ...
                <div className="blog-details ml-8 space-y-4">
                    <p className="text-lg font-medium text-gray-300">{blog.description}</p>
            ...
            {blog?.userEmail === user?.email ? (
                <div className="comments-section space-y-4">
                    ...
                    <p className="text-sm text-red-500">Cannot comment on your own blog.</p>
                </div>
            ) : (
                <div className="comments-section space-y-4">
                    <h2 className="text-2xl font-semibold">Comments</h2>
